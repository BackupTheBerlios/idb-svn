...
<?php echo $ThemeSet['TitleIcon'] ?><a href="">Updating Settings</a>
...
<tr class="TableRow1">
<td class="TableRow1"><span style="float: left;">
&nbsp;<a href="">iDB Database Manager</a></span>
...
<tr class="TableRow3">
<td class="TableRow3">
<form style="display: inline;" method="post" name="install" id="install" action="">
