...
unset($LastTopic);
$gltquery = $safesql->query("select * from ".$Settings['sqltable']."topics where CategoryID=%i and ForumID=%i", array($CategoryID,$ForumID));
...
$LastTopic = "Made By: <a href=\"#".$UsersID."\" title=\"".$oldusername."\">".$UsersName."</a><br />\nTopic Name: <a href=\"Topic.php?act=View&amp;id=".$TopicID."&amp;ForumID=".$ForumID."&amp;CatID=".$CategoryID."\" title=\"".$oldtopicname."\">".$TopicName."</a>"; }
