...
$filewpath = "category".$usefileext.$_SERVER['PATH_INFO'];
if($Settings['html_type']=="html4") { ?>
<link rel="alternate" type="application/rss+xml" title="Board RSS Feed" href="<?php echo url_maker("rss",$Settings['rss_ext'],array("act","CatID"),array("BoardFeed",$_GET['id']),$Settings['qstr'],$Settings['qsep']); ?>">
...
<?php
change_title($Settings['board_name']." - Viewing Category ".$CategoryName,$Settings['use_gzip']);
?>
