...
$Two = $Two.'<item>'."\n".'<title>'.htmlentities($HelpName).'</title>'."\n".'<description>'.htmlentities($HelpName).'</description>'."\n".'<link>'.$BoardURL.'Help.php?act=Help&amp;id='.$HelpID.'</link>'."\n".'<guid>'.$BoardURL.'Help.php?act=Help&amp;id='.$HelpID.'</guid>'."\n".'</item>'."\n";
++$i; }
if ($act=="Download") {
...
<channel>
   <title><?php echo htmlentities($Settings['board_name']); ?> - Help Files</title>
   <description>RSS Feed of the Help Files in Board <?php echo htmlentities($Settings['board_name']); ?></description>
