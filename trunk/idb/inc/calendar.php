...
$MyYear2 = GMTimeGet("y",$YourOffSet);
...
$EventDay = GMTimeChange("d",$EventStart,$YourOffSet);
$EventDayEnd = GMTimeChange("d",$EventEnd,$YourOffSet);
...
<table class="Table1" style="width: 100%;"><tr class="TableRow1">
