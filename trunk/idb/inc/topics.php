...
$glrquery = $safesql->query("select * from ".$Settings['sqltable']."posts where CategoryID=%i and ForumID=%i and TopicID=%i ORDER BY TimeStamp", array($_GET['CatID'],$_GET['id'],$TopicID));
...
<a href="Topic.php?id=<?php echo $TopicID ?>&amp;ForumID=<?php echo $_GET['id']; ?>&amp;CatID=<?php echo $_GET['CatID']; ?>&amp;act=View"><?php echo $TopicName; ?></a></div>
