...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 144; $RName = "iDB EH"; $SFName = "IntDB Easy Host";
$SVNDay[0] = 01; $SVNDay[1] = 01; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
...
$CD2k = "Ren&eacute; Johnson"; $GM2k = "iDB Easy Team";
