...
<link rel="alternate" type="application/rss+xml" title="Forum Topics RSS Feed" href="<?php echo url_maker($exfile['rss'],$Settings['rss_ext'],array("act","id"),array("topicrss",$_GET['id']),$Settings['qstr'],$Settings['qsep'],$exqstr['rss']); ?>">
