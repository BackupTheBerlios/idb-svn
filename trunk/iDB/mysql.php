...
@header("Content-Type: application/x-javascript; charset=iso-8859-15"); } else {
if(stristr($_SERVER["HTTP_ACCEPT"],"application/javascript") ) {
@header("Content-Type: application/javascript; charset=iso-8859-15"); } else {
...
// Skin Stuff
if($urlvars[2]=="theme"||$urlvars[2]=="skin"||
	$urlvars[2]=="style"||$urlvars[2]=="css") {
	if($urlvars[3]!=null) {
		$_GET['theme'] = $urlvars[3]; } }
if($_GET['theme']==null) {
	if($_POST['theme']!=null) {
...
else { $_GET['theme']="iDB"; $_SESSION['Theme']="iDB";
...
@redirect("location",$basedir.url_maker("members",$Settings['file_ext'],array("act"),array("logout"),$Settings['qstr'],$Settings['qsep'],FALSE)); } }
?>
