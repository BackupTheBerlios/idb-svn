...
/*
    ...
    $FileInfo: signup.php - Last Update: 10/16/2007 SVN 118 - Author: cooldude2k $
*/
...
$SetupDir['setup'] = "signup/"; $ConvertDir['setup'] = $SetupDir['setup'];
$SetupDir['convert'] = null; $ConvertDir['convert'] = $SetupDir['convert'];
