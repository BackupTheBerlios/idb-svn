...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 300; $RName = "iDB EH"; $SFName = "IntDB Easy Host";
...
$VerCheckURL = "http://idb.berlios.de/?act=vercheck&name=iDB-Host|".$VER2[1]."|".$VER1[0].".".$VER1[1].".".$VER1[2]."|".$VER2[2]."|".$SubVerN;
