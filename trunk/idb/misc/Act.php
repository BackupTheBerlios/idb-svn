...
/*$_SESSION['iDBVer']="v3.3.T<!-- Renee Sabonis -->";
$_SESSION['iDBPreVer']="&nbsp;Beta 4";*/
...
$iDBURL1 = "<a href=\"http://df2k.berlios.de/DF2k/index.php?act=View\">"; $iDBURL2 = $iDBURL1.$iDB."</a>";
$iTBURL1 = "<a href=\"http://df2k.berlios.de/DF2k/TagBoard.php?act=View\">"; $iTBURL2 = $iTBURL1.$iTB."</a>";
$PHPQA = "PHP-Quick-Arcade";
$VER1 = "0.1.9"; $VER2 = "Pre-Alpha 9"; $VER3 = "PA 9"; 
...
header("X-Powered-By-Ver: iDB ".$VER1." ".$VER3);
