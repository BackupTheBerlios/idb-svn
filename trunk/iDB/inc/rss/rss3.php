...
/*
    ...
    $FileInfo: rss3.php - Last Update: 04/28/2007 SVN 51 - Author: cooldude2k $
*/
...
if ($_GET['subid']==null) {
	$_GET['subid']=0; }
$query = query("select * from ".$Settings['sqltable']."categories where ShowCategory='Yes' and InSubForum=%i ORDER BY ID", array($_GET['subid']));
$preresult1=mysql_query($query);
$num=mysql_num_rows($preresult1);
$Atom = null; $RSS = null; $prei1=0;
while ($prei1 < $num) {
