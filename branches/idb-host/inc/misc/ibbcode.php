...
/*
    ...
    $FileInfo: ibbcode.php - Last Update: 05/05/2011 SVN 651 - Author: cooldude2k $
*/
...
$text = preg_replace("/\[DIV\=([A-Za-z0-9\;\,\s\#\(\)]+)\](.*?)\[\/DIV\]/is", "<div style=\"\\1\">\\2</div>", $text);
$text = preg_replace("/\[SPAN\=([A-Za-z0-9\;\,\s\#\(\)]+)\](.*?)\[\/SPAN\]/is", "<span style=\"\\1\">\\2</span>", $text);
