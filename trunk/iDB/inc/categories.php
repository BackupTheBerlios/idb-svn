...
/*
    ...
    $FileInfo: categories.php - Last Update: 04/27/2007 SVN 48 - Author: cooldude2k $
*/
...
if ($File3Name=="categories.php"||$File3Name=="/categories.php") {
	require('index.php');
	exit(); }
$prequery = query("select * from ".$Settings['sqltable']."categories where ID=%i and ShowCategory='on' and InSubForum=%i", array($_GET['id'],$_GET['subid']));
