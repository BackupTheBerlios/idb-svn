...
<tr style="text-align: left;">
	...
	<td style="width: 70%;"><input type="password" name="AdminPasswords" class="TextBox" id="AdminPassword" size="20" maxlength="30" /></td>
</tr><tr>
...
$query = "INSERT INTO ".$_POST['tableprefix']."members VALUES (1,'".$_POST['AdminUser']."','".$NewPassword."','DF4H','".$Email."',1,'yes',0,'".$Interests."','Admin',".$YourDate.",".$YourDate.",'".$NewSignature."','Your Notes','".$Avatar."','100x100','".$YourWebsite."','UnKnow',0,'".$AdminTime."','off','iDB','".$UserIP."','')";
$result = mysql_query($query);
