...
/*
    ...
    $FileInfo: filename.php - Last Update: 04/28/2007 SVN 49 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 49; 
$SVNDay[0] = 4; $SVNDay[1] = 28; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
