...
/*
    ...
    $FileInfo: filename.php - Last Update: 04/17/2007 SVN 47 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 47; 
$SVNDay[0] = 4; $SVNDay[1] = 17; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
