...
$Settings['ubid'] = base64_encode(urlencode($Settings['idburl']));
...
@ini_set("user_agent", "Mozilla/5.0 (compatible; iDBEH-Mod/".$iverstring."; +".$isiteurl.")"); }
...
<version>
 <charset><?php echo $Settings['charset']; ?></charset> 
  ...
  <vname>iDBEH-Mod Version Checker</vname>
</version>
